      ...
      <v-container class="pa-0" fluid>
        <v-row>
          ...
          <v-col cols="6" class="d-flex justify-end">
            <v-chip color="success" style="min-width: 125px; max-width: 130px; display: grid; place-items: center;" v-if="!loading">14 On</v-chip>
            <v-progress-circular
              indeterminate
              color="accent"
              v-else
        ...
        <v-row>
          ...
          <v-col cols="6" class="d-flex justify-end">
            <v-chip style="min-width: 125px; max-width: 130px; display: grid; place-items: center;" v-if="!loading">1.7 GH/s</v-chip>
            <v-progress-circular
              indeterminate
              color="accent"
              v-else
        ...
        <v-row>
          ...
          <v-col cols="6" class="d-flex justify-end">
            <v-chip style="min-width: 125px; max-width: 130px; display: grid; place-items: center;" v-if="!loading">CAD 2,000.00</v-chip>
            <v-progress-circular
              indeterminate
              color="accent"
              v-else
